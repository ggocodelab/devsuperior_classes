package com.oliveiralia.beecrowd2611;
...
import com.oliveiralia.beecrowd2611.repositories.MovieRepository;

@SpringBootApplication
public class Beecrowd2611Application implements CommandLineRunner{
	
	@Autowired
	private MovieRepository repository;

	public static void main(String[] args) {
		SpringApplication.run(Beecrowd2611Application.class, args);
	}
