package com.oliveiralia.beecrowd2621;
...
import com.oliveiralia.beecrowd2621.repositories.ProductRepository;

@SpringBootApplication
public class Beecrowd2621Application implements CommandLineRunner{
	@Autowired
	private ProductRepository repository;
	
	public static void main(String[] args) {
		SpringApplication.run(Beecrowd2621Application.class, args);
	}
